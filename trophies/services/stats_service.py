...
def _compute_recap_stats(profile):
    ...
    return {
        ...
        # No lifetime badge-XP total here: the recap-stats card is a fixed 4-cell grid and a fifth
        # would orphan. Worth adding when My Stats is rebuilt -- badge_xp_earned now carries a real number.
