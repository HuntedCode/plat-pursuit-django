...
from trophies.models import ProfileGame, EarnedTrophy, Profile

class Command(BaseCommand):
    def add_arguments(self, parser):
        parser.add_argument('--batch_size', type=int, default=100, help="Batch size for updates.")
        parser.add_argument('--username', type=str, required=True, help="Profile PSN username.")
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"Profile for username {username} does not exist."))
