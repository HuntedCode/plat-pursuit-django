...
MILESTONE_DEFINITIONS = [
    ...
    {'name': 'Regular',               'criteria_type': 'playtime_hours', 'criteria_details': {'target': 200},   'description': 'One hundred and seventy-five hours. Gaming is your thing.'},
    {'name': 'Committed',             'criteria_type': 'playtime_hours', 'criteria_details': {'target': 350},   'description': 'Two hundred and fifty hours. You show up consistently.',            'title_name': 'Dedicated'},
    {'name': 'Enthusiast',            'criteria_type': 'playtime_hours', 'criteria_details': {'target': 500},   'description': 'Four hundred hours. More than a casual hobby.'},
    {'name': 'Half a Grand',          'criteria_type': 'playtime_hours', 'criteria_details': {'target': 750},   'description': 'Five hundred hours. Gaming is more than a hobby now.'},
    {'name': 'Absorbed',              'criteria_type': 'playtime_hours', 'criteria_details': {'target': 1000},  'description': 'Seven hundred and fifty hours. Fully immersed.'},
    {'name': 'Time Well Spent',       'criteria_type': 'playtime_hours', 'criteria_details': {'target': 1500},  'description': 'One thousand hours. Or so you keep telling yourself.'},
    {'name': 'Deeply Invested',       'criteria_type': 'playtime_hours', 'criteria_details': {'target': 2000},  'description': 'Fifteen hundred hours in the chair.',                              'title_name': 'Veteran'},
    {'name': 'Two Thousand Hours',    'criteria_type': 'playtime_hours', 'criteria_details': {'target': 3000},  'description': 'Two thousand hours. That is a lot of controller time.'},
    {'name': 'Seasoned',              'criteria_type': 'playtime_hours', 'criteria_details': {'target': 4000},  'description': 'Two thousand five hundred hours in the trenches.'},
    {'name': 'Marathon Gamer',        'criteria_type': 'playtime_hours', 'criteria_details': {'target': 5500},  'description': 'Three thousand hours. You play the long game.'},
    {'name': 'Iron Endurance',        'criteria_type': 'playtime_hours', 'criteria_details': {'target': 7000},  'description': 'Three thousand five hundred hours. Unstoppable.'},
    {'name': 'Tireless',              'criteria_type': 'playtime_hours', 'criteria_details': {'target': 9000},  'description': 'Four thousand hours. You do not know the meaning of a break.',      'title_name': 'Timeless'},
    {'name': 'Lifetime Gamer',        'criteria_type': 'playtime_hours', 'criteria_details': {'target': 12000}, 'description': 'Five thousand hours. A lifetime of gaming memories.',             'title_name': 'Lifer'},
    {'name': 'Beyond Dedication',     'criteria_type': 'playtime_hours', 'criteria_details': {'target': 15000}, 'description': 'Six thousand hours. This transcends dedication.',                 'title_name': 'Beyond Dedicated'},
    {'name': 'All-Timer',             'criteria_type': 'playtime_hours', 'criteria_details': {'target': 20000}, 'description': 'Seven thousand five hundred hours. Time has no meaning.',         'title_name': 'All-Timer'},
    {'name': 'Eternal Player',        'criteria_type': 'playtime_hours', 'criteria_details': {'target': 25000}, 'description': 'Nine thousand hours. Gaming is eternal.',                        'title_name': 'Eternal Player'},
    {'name': 'No Life (Affectionate)','criteria_type': 'playtime_hours', 'criteria_details': {'target': 30000}, 'description': 'Ten thousand hours. Touch grass? Never heard of it.',               'title_name': 'The Eternal'},
