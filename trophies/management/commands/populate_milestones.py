...
MILESTONE_DEFINITIONS = [
    ...
    {'name': 'Lifetime Gamer',        'criteria_type': 'playtime_hours', 'criteria_details': {'target': 5000},  'description': 'Five thousand hours. A lifetime of gaming memories.',             'title_name': 'Lifer'},
    {'name': 'Beyond Dedication',     'criteria_type': 'playtime_hours', 'criteria_details': {'target': 6000},  'description': 'Six thousand hours. This transcends dedication.',                 'title_name': 'Beyond Dedicated'},
    {'name': 'All-Timer',             'criteria_type': 'playtime_hours', 'criteria_details': {'target': 7500},  'description': 'Seven thousand five hundred hours. Time has no meaning.',         'title_name': 'All-Timer'},
    {'name': 'Eternal Player',        'criteria_type': 'playtime_hours', 'criteria_details': {'target': 9000},  'description': 'Nine thousand hours. Gaming is eternal.',                        'title_name': 'Eternal Player'},
