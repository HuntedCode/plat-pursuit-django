...
MILESTONE_DEFINITIONS = [
    ...
    {'name': 'Unstoppable',           'criteria_type': 'plat_count', 'criteria_details': {'target': 400},  'description': 'Four hundred platinums. Nothing can slow you down.',               'title_name': 'Platinum Force'},
    {'name': 'Trophy Titan',          'criteria_type': 'plat_count', 'criteria_details': {'target': 500},  'description': 'Five hundred platinums. Few have walked this path.',                'title_name': 'Trophy Titan'},
    {'name': 'Living Legend',         'criteria_type': 'plat_count', 'criteria_details': {'target': 650},  'description': 'Six hundred and fifty platinums. Stories are told about you.',      'title_name': 'Living Legend'},
    {'name': 'Platinum Ascendant',    'criteria_type': 'plat_count', 'criteria_details': {'target': 800},  'description': 'Eight hundred platinums. You have ascended beyond.',                'title_name': 'Ascendant'},
    ...
    {'name': 'Trophy Warlord',        'criteria_type': 'trophy_count', 'criteria_details': {'target': 20000}, 'description': 'Twenty thousand trophies. A force of nature.',                   'title_name': 'Trophy Warlord'},
    {'name': 'Trophy Monarch',        'criteria_type': 'trophy_count', 'criteria_details': {'target': 25000}, 'description': 'Twenty-five thousand trophies. All hail the monarch.',              'title_name': 'Trophy Monarch'},
    {'name': 'Trophy Colossus',       'criteria_type': 'trophy_count', 'criteria_details': {'target': 30000}, 'description': 'Thirty thousand trophies. A towering achievement.',                 'title_name': 'Trophy Colossus'},
    {'name': 'Trophy Demigod',        'criteria_type': 'trophy_count', 'criteria_details': {'target': 40000}, 'description': 'Forty thousand trophies. Approaching godhood.',                    'title_name': 'Trophy Demigod'},
    ...
    # ── playtime_hours (20 tiers, max 30,000) ───────────────────────────
    ...
    {'name': 'Tireless',              'criteria_type': 'playtime_hours', 'criteria_details': {'target': 9000},  'description': 'Nine thousand hours. You do not know the meaning of a break.',      'title_name': 'Timeless'},
    ...
    {'name': 'Guiding Light',         'criteria_type': 'checklist_upvotes', 'criteria_details': {'target': 600},  'description': 'Six hundred upvotes. A beacon for lost hunters.',               'title_name': 'Guiding Light'},
    {'name': 'Platinum Sherpa',       'criteria_type': 'checklist_upvotes', 'criteria_details': {'target': 700},  'description': 'Seven hundred upvotes. You carry hunters to the summit.',       'title_name': 'Platinum Sherpa'},
    {'name': 'Master Cartographer',   'criteria_type': 'checklist_upvotes', 'criteria_details': {'target': 800},  'description': 'Eight hundred upvotes. Your maps are legendary.',               'title_name': 'Master Cartographer'},
    {'name': 'Trailhead Legend',      'criteria_type': 'checklist_upvotes', 'criteria_details': {'target': 900},  'description': 'Nine hundred upvotes. A trailhead legend.',                    'title_name': 'Trailhead Legend'},
    ...
    {'name': 'Badge Overlord',        'criteria_type': 'badge_count', 'criteria_details': {'target': 120}, 'description': 'One hundred and twenty badges. You rule the badge realm.',          'title_name': 'Badge Overlord'},
    {'name': 'Badge Legend',          'criteria_type': 'badge_count', 'criteria_details': {'target': 140}, 'description': 'One hundred and forty badges. Legendary status.',                    'title_name': 'Badge Legend'},
    ...
    {'name': 'Quarter Thousand Perfect', 'criteria_type': 'completion_count', 'criteria_details': {'target': 250}, 'description': 'Two hundred and fifty completions. Staggering.',              'title_name': 'Flawless'},
    {'name': 'Completion Machine',    'criteria_type': 'completion_count', 'criteria_details': {'target': 300}, 'description': 'Three hundred games at 100%. You are a machine.',                'title_name': 'Completion Machine'},
    {'name': 'Completion Deity',      'criteria_type': 'completion_count', 'criteria_details': {'target': 375}, 'description': 'Three hundred and seventy-five completions. Approaching divine.','title_name': 'Completion Deity'},
    {'name': 'Flawless Legend',       'criteria_type': 'completion_count', 'criteria_details': {'target': 450}, 'description': 'Four hundred and fifty completions. Flawless, legendary.',      'title_name': 'Flawless Legend'},
    ...
    {'name': 'Second Run: Five',      'criteria_type': 'az_progress', 'criteria_details': {'target': 31}, 'description': 'Five letters into your second A-Z. Back for more.',                  'title_name': 'Double Dipper'},
    {'name': 'Second Run: Ten',       'criteria_type': 'az_progress', 'criteria_details': {'target': 36}, 'description': 'Ten letters on the second run. You know the drill.',                  'title_name': 'Alphabet Veteran'},
    {'name': 'Second Run: Sixteen',   'criteria_type': 'az_progress', 'criteria_details': {'target': 42}, 'description': 'Sixteen letters on round two. Past the halfway mark again.',          'title_name': 'Letter Collector'},
    ...
    {'name': 'March Hunter',     'criteria_type': 'calendar_month_mar', 'criteria_details': {'target': 1}, 'description': 'Every day in March covered with a platinum.',     'title_name': 'Spring Breaker'},
    {'name': 'April Hunter',     'criteria_type': 'calendar_month_apr', 'criteria_details': {'target': 1}, 'description': 'Every day in April covered with a platinum.',     'title_name': "Fool's Gold"},
    {'name': 'May Hunter',       'criteria_type': 'calendar_month_may', 'criteria_details': {'target': 1}, 'description': 'Every day in May covered with a platinum.',       'title_name': 'May Day'},
    {'name': 'June Hunter',      'criteria_type': 'calendar_month_jun', 'criteria_details': {'target': 1}, 'description': 'Every day in June covered with a platinum.',      'title_name': 'Solstice'},
    {'name': 'July Hunter',      'criteria_type': 'calendar_month_jul', 'criteria_details': {'target': 1}, 'description': 'Every day in July covered with a platinum.',      'title_name': 'Firecracker'},
    {'name': 'August Hunter',    'criteria_type': 'calendar_month_aug', 'criteria_details': {'target': 1}, 'description': 'Every day in August covered with a platinum.',    'title_name': 'Dog Days'},
    {'name': 'September Hunter', 'criteria_type': 'calendar_month_sep', 'criteria_details': {'target': 1}, 'description': 'Every day in September covered with a platinum.', 'title_name': 'Harvest Moon'},
    {'name': 'October Hunter',   'criteria_type': 'calendar_month_oct', 'criteria_details': {'target': 1}, 'description': 'Every day in October covered with a platinum.',   'title_name': 'Spooktacular'},
    {'name': 'November Hunter',  'criteria_type': 'calendar_month_nov', 'criteria_details': {'target': 1}, 'description': 'Every day in November covered with a platinum.',  'title_name': 'Thankless'},
    {'name': 'December Hunter',  'criteria_type': 'calendar_month_dec', 'criteria_details': {'target': 1}, 'description': 'Every day in December covered with a platinum.',  'title_name': 'Frost Walker'},

    # ── calendar_months_total (4 tiers) ─────────────────────────────────
    {'name': 'Quarterly Calendar',    'criteria_type': 'calendar_months_total', 'criteria_details': {'target': 3},  'description': 'Three months of the calendar fully covered.',           'title_name': 'Seasonal'},
    ...
    {'name': 'Three Quarters Cal.',   'criteria_type': 'calendar_months_total', 'criteria_details': {'target': 9},  'description': 'Nine months filled. Just one season to go.',           'title_name': 'Calendar Veteran'},
    ...
    {'name': 'Thirty-Three Months',     'criteria_type': 'subscription_months', 'criteria_details': {'target': 33}, 'description': 'Thirty-three months. The road stretches behind you.',                    'premium_only': True, 'title_name': 'Loyalist'},
    {'name': 'Three Year Pillar',       'criteria_type': 'subscription_months', 'criteria_details': {'target': 36}, 'description': 'Three years of premium. You are a pillar of Platinum Pursuit.',          'premium_only': True, 'title_name': 'Cornerstone'},
    ...
    {'name': 'Four Year Foundation',    'criteria_type': 'subscription_months', 'criteria_details': {'target': 48}, 'description': 'Four years of support. You are part of the foundation.',                 'premium_only': True, 'title_name': 'Foundation'},
    {'name': 'Fifty-Four Months',       'criteria_type': 'subscription_months', 'criteria_details': {'target': 54}, 'description': 'Fifty-four months. The summit is in view.',                              'premium_only': True, 'title_name': 'Bedrock'},
    ...
    {'name': 'Getting Ink',              'criteria_type': 'review_count', 'criteria_details': {'target': 3},   'description': 'Three quality reviews. You have thoughts worth sharing.'},
    {'name': 'Pen to Paper',             'criteria_type': 'review_count', 'criteria_details': {'target': 5},   'description': 'Five quality reviews. The pen is your weapon of choice.'},
    {'name': 'Review Enthusiast',        'criteria_type': 'review_count', 'criteria_details': {'target': 8},   'description': 'Eight quality reviews. You are building a reputation.'},
    {'name': 'Ten Reviews Deep',         'criteria_type': 'review_count', 'criteria_details': {'target': 10},  'description': 'Ten quality reviews. A trusted voice in the community.',                     'title_name': 'Seasoned Writer'},
    {'name': 'Steady Pen',               'criteria_type': 'review_count', 'criteria_details': {'target': 15},  'description': 'Fifteen quality reviews. Consistent and insightful.'},
    {'name': 'Seasoned Critic',          'criteria_type': 'review_count', 'criteria_details': {'target': 20},  'description': 'Twenty quality reviews. Your experience shows in every word.'},
    {'name': 'Review Regular',           'criteria_type': 'review_count', 'criteria_details': {'target': 25},  'description': 'Twenty-five quality reviews. The community counts on you.'},
    {'name': 'Dedicated Writer',         'criteria_type': 'review_count', 'criteria_details': {'target': 35},  'description': 'Thirty-five quality reviews. Writing is second nature now.'},
    {'name': 'Prolific Penman',          'criteria_type': 'review_count', 'criteria_details': {'target': 50},  'description': 'Fifty quality reviews. A true wordsmith of the trophy world.',              'title_name': 'Wordsmith'},
    {'name': 'Review Veteran',           'criteria_type': 'review_count', 'criteria_details': {'target': 65},  'description': 'Sixty-five quality reviews. Your perspective is invaluable.'},
    {'name': 'Page Turner',              'criteria_type': 'review_count', 'criteria_details': {'target': 80},  'description': 'Eighty quality reviews. People keep coming back for more.'},
    {'name': 'Century Scribe',           'criteria_type': 'review_count', 'criteria_details': {'target': 100}, 'description': 'One hundred quality reviews. A century of shared wisdom.'},
    {'name': 'Review Aficionado',        'criteria_type': 'review_count', 'criteria_details': {'target': 120}, 'description': 'One hundred and twenty quality reviews. You live and breathe critique.'},
    {'name': 'Master Critic',            'criteria_type': 'review_count', 'criteria_details': {'target': 140}, 'description': 'One hundred and forty quality reviews. Your craft is refined.',             'title_name': 'Master Critic'},
    {'name': 'Review Sage',              'criteria_type': 'review_count', 'criteria_details': {'target': 160}, 'description': 'One hundred and sixty quality reviews. Wisdom in every word.',              'title_name': 'Review Sage'},
    {'name': 'Grand Reviewer',           'criteria_type': 'review_count', 'criteria_details': {'target': 180}, 'description': 'One hundred and eighty quality reviews. A grand body of work.',             'title_name': 'Grand Reviewer'},
    {'name': 'Review Titan',             'criteria_type': 'review_count', 'criteria_details': {'target': 200}, 'description': 'Two hundred quality reviews. A titan of the written word.',                 'title_name': 'Review Titan'},
    {'name': 'Legendary Author',         'criteria_type': 'review_count', 'criteria_details': {'target': 225}, 'description': 'Two hundred and twenty-five quality reviews. Your legacy is written.',      'title_name': 'Legendary Author'},
    {'name': 'The Review Pursuit',       'criteria_type': 'review_count', 'criteria_details': {'target': 250}, 'description': 'Two hundred and fifty quality reviews. You have pursued every word.',       'title_name': 'The Scribe'},

    # ── review_helpful_count (20 tiers, max 1,000) ────────────────────
    {'name': 'Helpful Hand',             'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 1},    'description': 'Someone found your review helpful. It begins!',                    'title_name': 'Helpful'},
    {'name': 'Getting Attention',         'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 3},    'description': 'Three helpful votes. People are taking notice.'},
    {'name': 'Good Takes',              'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 5},    'description': 'Five helpful votes. Your takes are landing well.'},
    {'name': 'Insightful Reviewer',      'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 10},   'description': 'Ten helpful votes. Your insights cut through the noise.'},
    {'name': 'Trusted Takes',            'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 25},   'description': 'Twenty-five helpful votes. Hunters trust your judgment.',           'title_name': 'Trusted Reviewer'},
    {'name': 'Resonating Words',         'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 40},   'description': 'Forty helpful votes. Your words resonate with many.'},
    {'name': 'Community Compass',        'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 60},   'description': 'Sixty helpful votes. You point hunters in the right direction.'},
    {'name': 'Go-To Reviewer',           'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 80},   'description': 'Eighty helpful votes. You are the go-to voice on games.'},
    {'name': 'Hundred Helpful',          'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 100},  'description': 'One hundred helpful votes. A milestone of community trust.'},
    {'name': 'Review Beacon',            'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 135},  'description': 'One hundred and thirty-five helpful votes. A beacon for hunters.',  'title_name': 'Review Beacon'},
    {'name': 'Guiding Voice',            'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 175},  'description': 'One hundred and seventy-five helpful votes. Your voice guides many.'},
    {'name': 'Review Pillar',            'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 225},  'description': 'Two hundred and twenty-five helpful votes. A pillar of the community.'},
    {'name': 'Review Champion',          'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 300},  'description': 'Three hundred helpful votes. Champion of the review board.'},
    {'name': 'Review Authority',         'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 400},  'description': 'Four hundred helpful votes. Your authority is undeniable.'},
    {'name': 'Review Oracle',            'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 500},  'description': 'Five hundred helpful votes. The oracle has spoken.',                'title_name': 'Review Oracle'},
    {'name': 'Helpful Legend',           'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 600},  'description': 'Six hundred helpful votes. Legendary helpfulness.',                 'title_name': 'Helpful Legend'},
    {'name': 'Community Luminary',       'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 700},  'description': 'Seven hundred helpful votes. A luminary of the community.',         'title_name': 'Community Luminary'},
    {'name': 'Review Sovereign',         'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 800},  'description': 'Eight hundred helpful votes. You reign supreme.',                  'title_name': 'Review Sovereign'},
    {'name': 'Nine Hundred Strong',      'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 900},  'description': 'Nine hundred helpful votes. The voice of a thousand hunters.',     'title_name': 'Voice of Hunters'},
    {'name': 'The Helpful Pursuit',      'criteria_type': 'review_helpful_count', 'criteria_details': {'target': 1000}, 'description': 'One thousand helpful votes. The ultimate pursuit of helpfulness.',  'title_name': 'The Advisor'},
]
# fmt: on
