...
class BadgeCreationForm(forms.Form):
    ...
    badge_type = forms.ChoiceField(choices=[('series', 'Series'), ('collection', 'Collection'), ('megamix', 'Megamix')], required=True, label="Badge Type", widget=forms.Select(attrs={'class': 'select w-full'}))
