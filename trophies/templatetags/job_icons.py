...
_ICONS = {
    ...
    'spade': '<path d="M5 9c-1.5 1.5-3 3.2-3 5.5A5.5 5.5 0 0 0 7.5 20c1.8 0 3-.5 4.5-2 1.5 1.5 2.7 2 4.5 2a5.5 5.5 0 0 0 5.5-5.5c0-2.3-1.5-4-3-5.5l-7-7z"/><path d="M12 18v4"/><path d="M8 22h8"/>',
    # Heart
    ...
    # Discipline section headers (dossier / character-sheet). Combat/Exploration/Mind reuse
    # swords/compass/brain above; these two complete the set.
...
@register.simple_tag
def job_icon(name, css_class='w-5 h-5'):
    """Render the inline Lucide SVG for a job's `icon` name (empty span if unknown/blank)."""
