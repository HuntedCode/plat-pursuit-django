...
from .badge_views import BadgeHowItWorksView, BadgeListView, BadgeDetailView, BadgeQuickPeekView, BadgeProgressPeekView, GroupBadgeInspectView, BadgeLeaderboardsView, OverallBadgeLeaderboardsView
...
__all__ = [
    ...
    # Badge views
    'BadgeHowItWorksView', 'BadgeListView', 'BadgeDetailView', 'BadgeQuickPeekView', 'BadgeProgressPeekView', 'GroupBadgeInspectView', 'BadgeLeaderboardsView', 'OverallBadgeLeaderboardsView',
