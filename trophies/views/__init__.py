...
from .checklist_views import ChecklistDetailView, ChecklistCreateView, ChecklistEditView, MyChecklistsView, MyShareablesView
...
__all__ = [
    ...
    # Checklist views
    'ChecklistDetailView', 'ChecklistCreateView', 'ChecklistEditView', 'MyChecklistsView', 'MyShareablesView',
    # Sync views
