...
PREMIUM_PERKS = [
    {'slug': 'sync', 'colour': '#4fc4a3',
     ...
     'example': "Tonight's 2am platinum, on your profile by 2:05."},
    {'slug': 'discord', 'colour': '#47b6e6',
     'name': 'Discord role and channel',
     'everyone': 'The server is open to anyone',
     'member': 'The server is open to anyone, and supporters get a role and a channel of their own.',
    ...
    {'slug': 'polls', 'colour': '#a666ea', 'asterisk': True,
     ...
     'member': 'Everyone has a voice in the Discord. Yours becomes a counted vote in what gets built next, including the badge polls.',
...
STRIPE_PRODUCTS = {
    'test': {
        ...
        'backer': 'prod_V735ZqzcE781QL',
        'contributor': 'prod_V735eFgQ8FlRRp',
        'patron': 'prod_V735dER1GhMN4k',
        'sponsor': 'prod_V735yGDzlgyevW',
        'benefactor': 'prod_V735rQrsUjmWux',
        'cornerstone': 'prod_V735Ci5LGofsJY',
    },
    'live': {
...
# BECAUSE they are marked as dreams). Content rules: no dates, no counts, ever. The storefront
# band compresses this same list (tier name + first few feature names), so both surfaces tell
# one story from one constant.
ROADMAP_FEATURES = [
    ...
    {'key': 'lists', 'tier': 'next',
     ...
     'blurb': 'Set aside to get 1.0 out of the door, and coming back rebuilt rather than rushed.'},
