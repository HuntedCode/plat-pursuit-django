            ...
            <div class="flex flex-col md:flex-row lg:flex-row gap-4">
                <div class="flex flex-row md:flex-col lg:flex-col items-center gap-3 md:w-32 lg:w-36 shrink-0">
                    ...
                    <div class="text-center md:text-left lg:text-left">
                        <a href="/hunters/${esc(author.psn_username || '')}/" class="font-bold text-sm ${author.is_premium ? 'legendary-title' : 'text-primary'} hover:underline line-clamp-1 pr-1">${esc(author.display_psn_username || author.psn_username || '')}</a>
