            ...
            <div class="flex flex-col md:flex-row lg:flex-row gap-4">
                <div class="flex flex-row md:flex-col lg:flex-col items-center gap-3 md:w-32 lg:w-36 shrink-0">
                    ...
                    <div class="text-center md:text-left lg:text-left">
                        <a href="/hunters/${esc(author.psn_username || '')}/" class="font-bold text-sm text-primary hover:underline line-clamp-1 pr-1">${esc(author.display_psn_username || author.psn_username || '')}</a>
                        ${author.displayed_title ? (author.title_source
                            ? `<div class="tooltip tooltip-bottom cursor-help" data-tip="${esc(author.title_source)}"><p class="text-xs text-secondary italic pr-1 line-clamp-1">${esc(author.displayed_title)}</p></div>`
                            : `<p class="text-xs text-secondary italic pr-1 line-clamp-1">${esc(author.displayed_title)}</p>`)
                        : ''}
