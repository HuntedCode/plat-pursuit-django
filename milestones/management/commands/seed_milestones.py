...
CATALOG = [
    ...
    },
    {
        ...
        'accent': '#2dd4bf',   # teal
        'description': 'Time as a member of the Platinum Pursuit community.',
        'metric': 'community_months', 'category': 'Supporter', 'sort_order': 70,
        'tiers': [1, 3, 6, 12, 24, 36, 48, 60, 96, 120],   # months (1mo -> 10yr)
    },
    {
        'slug': 'premium-supporter', 'name': 'Premium Supporter', 'icon': 'gem',
        'accent': '#fb7185',   # rose
        'description': 'Total time supporting the site with a premium membership.',
        'metric': 'premium_months', 'category': 'Supporter', 'sort_order': 80,
        'tiers': [1, 3, 6, 12, 18, 24, 36, 48, 60, 84],   # months
    },
]
