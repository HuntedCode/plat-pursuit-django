...
| `landing_badge_showcase_v1` | 3600s (300s on failure) | Anon landing's medallion shelf: top-earned live badges, one edition per series. Lazily filled on the request path (bounded) |
