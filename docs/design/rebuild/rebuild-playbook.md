...
**Fifteen pages are finished to the standard: Career, Collection, Badges, Badge Detail, Milestones, Titles, Browse Games, Game Detail, Recently Added, Genres & Themes (list + detail), Franchises (list + detail), Companies (list + detail).**
