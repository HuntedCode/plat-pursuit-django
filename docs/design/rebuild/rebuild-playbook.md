...
**Nine pages are finished to the standard: Career, Collection, Badges, Badge Detail, Browse Games, Game Detail, Recently Added, Genres & Themes (list + detail).**
