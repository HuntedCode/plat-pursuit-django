...
| `takeover(root, {onClose, recede, focusSel, onKey})` | Full-screen surface: scroll lock, page-recede, focus capture/restore, Tab trap, Escape. Defers Escape to a `<dialog>` opened inside it |
