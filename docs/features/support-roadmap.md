...
- **The wishlist labels itself as dreams** ("Dreams, labelled as dreams. No promises here, just
  direction.") — that subline is load-bearing copy, pinned by test. It is what lets ambitious
