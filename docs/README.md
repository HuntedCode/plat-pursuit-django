...
| [The Frontier: Game Layer](design/frontier/README.md) | **BRAINSTORM CAPTURE (2026-09).** A browser menu/idle/builder game layered on the Pursuer: trophies set your generation *rate*, you build a Village, and you explore the Backlog (a branching map of PlayStation history) for discs and cards. Five docs covering vision, systems, content model, the decision log (including rejected paths), and open questions. Lives on `feature/frontier`, nothing built. |
