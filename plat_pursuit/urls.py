...
urlpatterns = [
    ...
    # Collectibles sub-page (Phase 1: read-only viewer; per-type sub-URLs come in Phase 3).
    path('games/<str:np_communication_id>/collectibles/', CollectiblesDetailView.as_view(), name='collectibles_detail'),
