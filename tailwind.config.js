module.exports = {
  ...
  safelist: [
    ...
    // Category cards (dynamically constructed via template variable: flagged games, recently added)
    'badge-error', 'badge-warning', 'badge-accent', 'badge-info', 'badge-secondary',
    'ring-error/30', 'ring-warning/30', 'ring-info/30', 'ring-secondary/30',
    'border-info', 'border-secondary',
    'hover:border-error', 'hover:border-warning', 'hover:border-info', 'hover:border-secondary',
  ],
  theme: { extend: {} },
